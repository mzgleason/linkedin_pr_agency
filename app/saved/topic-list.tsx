...
import type { TopicDecision } from "../inbox/actions";
import { decideTopicStatusDirect } from "../inbox/actions";
...
export default function SavedTopicList({ initialTopics }: { initialTopics: SavedTopic[] }) {
  ...
  function decide(topicId: string, decision: Extract<TopicDecision, "APPROVED" | "REJECTED">) {
    setError(null);
