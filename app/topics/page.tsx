...
export default async function TopicsPage({ searchParams }: TopicsPageProps) {
  ...
  const subheading = status ? "Filtered by status." : "Approved or in-progress topics ready for drafting.";
            ...
            return (
              <div key={topic.id} className="rounded-2xl border border-neutral-200 bg-white p-4 shadow-sm">
                ...
                <div className="mt-3 flex items-center gap-3 text-xs text-neutral-600">
                  ...
                  <div className="rounded-full bg-neutral-100 px-2 py-1">Opinion: {hasOpinion ? "Captured" : "Missing"}</div>
                  <div className="rounded-full bg-neutral-100 px-2 py-1">
                    Draft:{" "}
